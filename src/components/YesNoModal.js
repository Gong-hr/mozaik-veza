...
import {unfollowEntity} from "../actions"
import {store} from "../index"
import {DELETE_FOLLOWED_ENTITY_CONFIRMATION, YES_CAPS, NO_CAPS, CLOSE} from "../lang"
...
export default class YesNoModal extends Component {
    ...
    handleYes = () => {
        ...
        store.dispatch(unfollowEntity(this.props.params[0], this.props.params[1]));
    };
            ...
            <div>
                <Modal className="LostPass-modal" isOpen={this.state.modal} onClosed={() => this.close()} toggle={this.toggle} >
                    <div className="modal-header">
                        <h5 className="modal-title">{DELETE_FOLLOWED_ENTITY_CONFIRMATION}</h5>
